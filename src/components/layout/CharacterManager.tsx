...
export default function CharacterManager() {
  ...
  return (
    <div className="flex flex-1 flex-col overflow-hidden bg-canvas">
            ...
            <div className="mx-auto max-w-2xl space-y-5 p-5">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="font-mono text-[12px] text-fg-faint">{selectedChar.charId}</div>
                </div>
              </div>
              ...
              <div>
                      ...
                      spriteAssets.map((asset) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            {alreadyUsed && <span className="ml-auto text-[12px] text-fg-faint">已使用</span>}
                          </button>
                        )
                      })
                    )}
                ...
                {selectedChar.expressions.length === 0 ? (
                  <p className="text-[12px] italic text-fg-faint">暂无表情</p>
                ) : (
                  <div className="grid grid-cols-2 gap-1.5">
                    {selectedChar.expressions.map((expr) => {
                      ...
                      return (
                        ...
                        >
                          <span className="w-14 shrink-0 truncate font-mono text-[12px] text-fg-subtle" title={expr.id}>
                            {expr.id}
                          </span>
      ...
      {/* 底部统计 */}
      <div className="border-t border-edge/10 px-3 py-1.5 text-[12px] text-fg-subtle">
...
function Field({
  ...
  return (
    <div>
      <label className="mb-0.5 block text-[12px] text-fg-subtle">{label}</label>
      <Input
        value={value}
        readOnly={readOnly}
